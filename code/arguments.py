...
def get_args():
    ...
    parser.add_argument('--perfect_teacher', action='store_true')   # agent 0 gets all the utilities and agent 1 gets none
    ...
    parser.add_argument('--save_dir', default='/home/dharakyu/signaling-bandits/raw_data/messages_for_qualitative_analysis', type=str)
